...
ggsave(filename = "figs/05_supp-mat/sst_anom_a.png", width = 10, height = 12, dpi = fig_resolution)
...
ggsave(filename = "figs/05_supp-mat/sst_anom_b.png", width = 10, height = 12, dpi = fig_resolution)
