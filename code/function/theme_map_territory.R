theme_map_territory <- function(base_size = 14, base_family = font_choose_map, base_line_size = base_size/22, base_rect_size = base_size/22){
  ...
  theme(line = element_line(colour = "black", 
        ...
        legend.background = element_rect(fill = "#ecf0f1", color = "#363737", linewidth = 0.25),
