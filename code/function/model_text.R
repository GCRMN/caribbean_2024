model_text <- function(category_i){
  ...
  result <- paste0("The temporal trend of benthic cover of ", category_name,
                   ...
                   "The model achieved a RMSE of ", value_rmse,
                   " indicating that its predictions deviate on average by ", value_rmse,
                   " percentage points from the observed cover values, while accounting for ", value_rsq*100,
                   " % of the variance in the data (R² = ", value_rsq, ").",
