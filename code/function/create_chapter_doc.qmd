...
read_xlsx("../../figs/01_part-1/tbl-1.xlsx") %>% 
  ...
  filter(area == area_i) %>% 
  select(reef_area_abs, reef_area_rel_caribbean, pop_reef_2020, pop_percent, pop_reef_change) %>% 
  mutate(across(c("reef_area_rel_caribbean", "pop_percent", "pop_reef_change"), ~paste0(.x, " %")),
