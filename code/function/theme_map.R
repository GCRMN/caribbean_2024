theme_map <- function(base_size = 10, base_family = font_choose_map, base_line_size = base_size/22, base_rect_size = base_size/22){
  ...
  theme(line = element_line(colour = "black", 
        ...
        axis.text.y = element_text(margin = margin(r = 0.8 * half_line/2), angle = 90, hjust = 0.5),
        axis.text.y.right = element_text(margin = margin(l = 0.8 * half_line/2), angle = -90, hjust = 0.5),
        ...
        panel.background = element_rect(fill = "#ecf6fe"), 
