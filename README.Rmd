...
* `a01_select_topo-bathy.js` Extract topography and bathymetry using Google Earth Engine (GEE).
...
* `a05_reef-buffer.js` Create coral reef buffer polygons at 20, 50, and 100 km using GEE.
...
* `b03_extract_indicator_population.js` Extract population indicator using GEE.
